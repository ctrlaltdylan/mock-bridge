...
exports.shouldEnableMockTokens = shouldEnableMockTokens;
 ...
 * ```
 */
function isMockToken(token, mockSecret = constants_1.STANDARD_MOCK_SECRET) {
    try {
        jsonwebtoken_1.default.verify(token, mockSecret, { algorithms: ['HS256'] });
        return true;
    }
    catch {
        return false;
 ...
 */
function shouldEnableMockTokens(developmentOnly = true) {
    if (!developmentOnly) {
        return true;
    }
    return process.env.NODE_ENV === 'development';
}
//# sourceMappingURL=isMockToken.js.map